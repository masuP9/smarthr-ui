    ...
    CheckboxComponent.prototype.render = function () {
        ...
        return (React.createElement(Wrapper, { className: classNames, theme: theme },
            checked && (React.createElement(IconWrap, null,
                React.createElement(Icon_1.Icon, { name: "check", size: 12, color: themeColor === 'light' ? '#fff' : theme.palette.MAIN }))),
...
var IconWrap = styled_components_1.default.span(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  display: inline-block;\n  width: 12px;\n  height: 12px;\n  transform: translate(-50%, -50%);\n\n  & > svg {\n    vertical-align: top;\n  }\n"], ["\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  display: inline-block;\n  width: 12px;\n  height: 12px;\n  transform: translate(-50%, -50%);\n\n  & > svg {\n    vertical-align: top;\n  }\n"])));
