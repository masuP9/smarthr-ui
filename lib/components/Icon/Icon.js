...
var CheckCircle_1 = require("./svg/CheckCircle");
var Cross_1 = require("./svg/Cross");
var ExclamationTriangle_1 = require("./svg/ExclamationTriangle");
var iconMap = {
    check: Check_1.Check,
    'check-circle': CheckCircle_1.CheckCircle,
    cross: Cross_1.Cross,
    'exclamation-triangle': ExclamationTriangle_1.ExclamationTriangle,
